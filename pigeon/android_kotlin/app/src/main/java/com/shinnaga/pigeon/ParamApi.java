...
public class ParamApi {
  ...
  public static final class Param {
    ...
    private @Nullable List<String> listStr;

    public @Nullable List<String> getListStr() {
      return listStr;
    }

    public void setListStr(@Nullable List<String> setterArg) {
      this.listStr = setterArg;
    }
    ...
    public static final class Builder {
      ...
      public @NonNull Builder setListStr(@Nullable List<String> setterArg) {
        this.listStr = setterArg;
        return this;
      }
      ...
      public @NonNull Param build() {
        ...
        pigeonReturn.setListStr(listStr);
        return pigeonReturn;
      }
    }
    ...
    static @NonNull Param fromList(@NonNull ArrayList<Object> list) {
      ...
      Object listStr = list.get(4);
      pigeonResult.setListStr((List<String>) listStr);
      return pigeonResult;
    }
  }
